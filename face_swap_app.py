...
## buttons to select face images
    btn1 = Button(root, text="Select first face", command=select_image1, padx="10", pady="10",bg = "white")
    btn1.place(x = 125, y = 350, height = 50, width = 150)

    btn2 = Button(root, text="Select second face", command=select_image2, padx="10", pady="10",bg = "white")
